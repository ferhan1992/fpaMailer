...
public class IMapConnectionHelper {
    ...
    public static Store connect(final Account acc) {
        try {
            ...
            final Store store;
            store = session.getStore(JAVA_MAIL_IMAPS);
